...
<html data-bs-theme="light" lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="/assets/css/styles.min.css?h=b5eeab7d6d7679d49f9fdc179e0b2cb4"
    />
  </head>
  <body>
          ...
          <li class="breadcrumb-item">
            <a href="/favorites  "
              ><svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="icon icon-tabler icon-tabler-heart fs-5 pe-0 me-2"
                                ...
                                <div>
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <form action="{{ route('favorites.delete') }}" method="POST">
                                            ...
                                            <button class="btn btn-outline-primary btn-lg mt-2" type="submit" title="Remove from Favorites" style="height: fit-content; width: fit-content; font-size: inherit; border-color: hotpink; color: hotpink;" onmouseover="this.style.color='white'" onmouseout="this.style.color='hotpink'">
                                              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-trash fs-4">
                                              <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                              <path d="M6 7l2 14h8l2 -14"></path>
                                              <path d="M9 10h6"></path>
