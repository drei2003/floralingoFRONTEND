                ...
                <div class="card d-flex flex-row-reverse" style="height: 675px; box-shadow: 0px 0px; border-radius: 20px">
                    ...
                    <div class="card-body d-xl-flex p-4 px-5 py-5" style="width: 978.188px">
                        <section class="px-xxl-5 px-xl-4 px-md-5 px-lg-0 my-0 me-0 px-0">
                            <!-- Start: heading -->
                            <div class="mb-4">
                                <a class="navbar-brand d-flex justify-content-center align-items-center justify-content-xxl-center mb-3" href="#"
                                    ><span
                            ...
                            <div>
                                <form>
                                    ...
                                    ><input class="form-control mb-3" type="text" id="fullname" placeholder="Full name" required="" /><label
                                        class="form-label"
                                        >Email address&nbsp;</label
                                    ><input
                                        ...
                                        required=""
                                    />
                                    <div class="d-flex justify-content-between"><label class="form-label">Password</label></div>
                                    <input class="form-control mb-3" type="password" id="password" placeholder="Password" required="" />
                                    <div class="d-flex justify-content-between"><label class="form-label">Confirm Password</label></div>
                                    <input class="form-control mb-4" type="password" id="confirmpass" placeholder="Confirm Password" required="" />
                                    <div class="mt-lg-3">
                                    ...
                                    <div class="mt-lg-3">
                                        <p class="d-xl-flex justify-content-xl-center" style="font-size: 13px">
                                            Already have an account?<span class="ms-2"
                                                ><a class="link-primary ms-0" href="/UserLogIn.html">Log In</a></span
                                            >
                                        </p>
                                    </div>
                                </form>
