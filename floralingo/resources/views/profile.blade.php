  ...
  <body>
    ...
    <section>
      <div class="container">
        <div>
          <ul
            class="nav nav-tabs nav-justified d-grid d-sm-flex"
            role="tablist"
          >
            ...
            <li class="nav-item" role="presentation">
              <a
                ...
                >
                  ...
                  ></path>
                  <path d="M9 11v-5a3 3 0 0 1 6 0v5"></path></svg
                ><strong>Purchase History</strong></a
              >
            </li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane mt-4 pb-0" role="tabpanel" id="tab-3">
              ...
              >
                <div class="card-body justify-content-evenly my-4">
                  <div
                    class="d-flex justify-content-between align-items-xxl-center mb-4 mb-sm-5"
                  >
                    <h5 class="fw-bold mb-0">Purchase History</h5>
                  </div>
                  <div>
                    <ul
                      class="nav nav-underline d-grid d-sm-flex"
                      role="tablist"
                    >
                      <li class="nav-item" role="presentation">
                        <a
                          ...
                          href="#tab-5"
                          >All Orders<span
                            class="badge rounded-pill bg-light ms-sm-1"
                            >4</span
                          ></a
                        >
                      </li>
