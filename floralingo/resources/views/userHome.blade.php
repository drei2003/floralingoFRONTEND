<!DOCTYPE html>
<html data-bs-theme="light" lang="en" style="border-bottom-color: var(--bs-primary)">
...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/styles.min.css?h=9e964e34980450ef3388fbfe06cde33f" />
</head>
...
<body>
        ...
        <ul class="navbar-nav mx-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="#NewRelease">New Release</a><a class="dropdown-item"
                href="#BestSellers">Best Sellers</a><a class="dropdown-item" href="#AllProducts">All Products</a>
            </div>
          </li>
          <!-- <li class="nav-item dropdown">
              <a
  ...
  <!-- End: Navbar Centered Links --><!-- Start: Hero Overlay -->
  <section class="text-white py-4 py-xl-5" style="background: transparent">
    <div class="border rounded border-0 d-flex flex-column justify-content-center align-items-center p-4 py-5" style="
          height: 500px;
          background: url('/assets/img/123.png?h=965a36c830df7c4bcdce8b3cbce78dda')
            center / cover;
        ">
      <div class="row">
        <div
          class="col-sm-10 col-md-7 col-lg-6 col-xl-5 col-xxl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
          <div>
            <h2
            ...
            <div
              class="d-flex d-md-flex justify-content-center justify-content-md-center justify-content-lg-center justify-content-xxl-center">
              <a class="btn btn-primary me-2" role="button" href="#"
                ...
                role="button" href="#floralingoDictionary" style="font-size: 18px">Dictionary
              </a>
            </div>
          </div>
        </div>
  ...
  <!-- End: Hero Overlay --><!-- Start: Stats Color -->
  <div class="container-lg py-0 mt-lg-5 py-xl-0 my-5 my-xl-0 mb-xl-5 mb-0" style="padding-top: 0px">
    <div class="text-center text-white-50 bg-primary border rounded border-0 p-3" style="
      ...
      <div class="row row-cols-2 row-cols-md-4">
        <div
          class="col-md-3 col-lg-3 col-xl-3 col-xxl-3 d-inline-flex justify-content-sm-center justify-content-xxl-center">
          <div class="p-3">
            <h4
              class="display-6 fw-bold text-lg-center text-white d-flex justify-content-center justify-content-lg-center justify-content-xxl-center mb-0"
              style="text-align: left">
              90%
            </h4>
            <p class="text-md-center d-md-flex mb-0">Freshness Guarantee</p>
          </div>
        </div>
        <div
          class="col-md-3 col-lg-3 col-xl-3 col-xxl-3 d-inline-flex justify-content-sm-center justify-content-xxl-center">
          <div class="p-3">
            <h4
              class="display-6 fw-bold text-white d-flex justify-content-center justify-content-lg-center justify-content-xxl-center mb-0"
              style="text-align: left">
              75%
            </h4>
        ...
        <div
          class="col-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3 d-inline-flex justify-content-center justify-content-sm-center justify-content-xxl-center">
          <div class="p-3">
            <h4 class="display-6 fw-bold text-white d-flex justify-content-lg-start justify-content-xxl-center mb-0"
              style="text-align: left">
              3,000+
            </h4>
            <p class="text-md-center mb-0">Happy Customers</p>
          </div>
        </div>
        <div
          class="col-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3 d-inline-flex justify-content-center justify-content-sm-center justify-content-xxl-center">
          <div class="p-3">
            ...
            <p class="text-md-center mb-0">Locally Sourced Fresh Blooms</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- End: promotional cards --><!-- Start: New Release -->
  <section id="NewRelease"></section>
  <div class="container mt-0 mb-5">
    <!-- Start: Header -->
    <div class="row px-4 mb-4">
      <div
        class="col-md-8 col-xl-7 col-xxl-4 offset-xl-1 text-center text-sm-start d-flex d-sm-flex flex-column justify-content-evenly mx-auto justify-content-sm-center align-items-xl-center">
        <h2 class="fw-semibold text-primary">New Release</h2>
        <p>Freshly Picked: Discover Our Latest Blooms</p>
      </div>
    </div>
      ...
      <div class="col-10 col-sm-6 col-md-4 col-lg-3 col-xl-3 px-3" style="margin-top: 35px; margin-bottom: 2px">
        ...
        <div class="d-flex justify-content-between">
          ...
          ₱<span id="productPrice-{{ $product->id }}"
            class="ms-xl-1">{{ number_format($product->Price, 2) }}</span>
          </p>
  ...
  <!-- End: New Release --><!-- Start: Best Sellers -->
  <section id="BestSellers"></section>
  <div class="container mb-4 mt-0 pt-5">
    <!-- Start: Header -->
    <div class="row px-4 mb-4">
      <div
        class="col-md-8 col-xl-7 col-xxl-4 offset-xl-1 text-center text-sm-start d-flex d-sm-flex flex-column justify-content-evenly mx-auto justify-content-sm-center align-items-xl-center">
        <h2 class="fw-semibold text-primary">Best Sellers</h2>
        <p>Customer Favorites: Our Best-Selling Products</p>
      </div>
    </div>
    <!-- End: Header --><!-- Start: cardHolder -->
    <div class="d-flex" style="overflow: auto">
  ...
  <!-- End: Best Sellers --><!-- Start: All Products -->
  ...
  <div class="container mt-5 mb-5 pb-5 pt-5">
    ...
    <div class="row px-4 mb-4">
      <div
        ...
        <p>Explore Them All: Our Full Collection Awaits</p>
      </div>
    </div>
    <!-- End: Header -->
  ...
  <!-- End: All Products -->
  <section id="floralingoDictionary" class="my-5 mt-5" style="background: #fff6f9">
    <section
  ...
  <section id="contactUs" style="background: transparent" class="pt-xl-5 pt-0">
    <!-- Start: about us -->
      ...
      <div
        ...
        style="
            background: linear-gradient(
              ...
              url('/assets/img/gc76777eba0de249d9e04644dc6b50918804209bcb1db0de1ea7a8ae1ea4d0a1792c7f2c6d43d990fc703b65ba6ae058059ecf6edacbdab70ed6ffda2e1f81cf0_640.jpg?h=d4f9c2133d7d085ae20f9fc595b20144')
                center / cover no-repeat,
              transparent;
          ">
        <div class="pb-2 pb-lg-1">
          <h1 class="fw-bold mb-2">FLORALINGO</h1>
          <p class="mb-0">Where Every Bloom Tells a Story</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-sm-5 col-md-5 col-lg-4 text-center text-lg-start d-flex flex-column item">
          ...
          <ul class="list-unstyled">
            <li><a class="link-dark" href="#NewRelease">Featured Products</a></li>
            <li><a class="link-dark" href="#AllProducts">Our Products</a></li>
            <li><a class="link-dark" href="#flowerDictionary">Flower Dictionary</a></li>
          </ul>
        </div>
        <!-- End: Sections -->
        <div class="col-sm-5 col-md-5 col-lg-4 text-center text-lg-start d-flex flex-column item">
          <ul class="list-unstyled">
            ...
            <li class="text-dark">
              <a class="link-dark" href="#contactUs">About Us</a>
            </li>
            <li class="text-dark">
