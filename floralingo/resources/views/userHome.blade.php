...
<html
  data-bs-theme="light"
  lang="en"
  style="border-bottom-color: var(--bs-primary)"
>
  <head>
    <meta charset="utf-8" />
    <meta
    ...
    <link
      rel="stylesheet"
      href="/assets/css/styles.min.css?h=9e964e34980450ef3388fbfe06cde33f"
    />
  </head>
  <body>
        ...
        <div class="row">
          ...
          >
            <div>
              ...
              >
                <span class="fs-1 text-lg-center text-muted">Welcome to</span
                >&nbsp;<br />FLORALINGO
              </h2>
      ...
      >
        <div class="row row-cols-2 row-cols-md-4">
          ...
          >
            <div class="p-3">
              <h4
                class="display-6 fw-bold text-white d-flex justify-content-lg-start justify-content-xxl-center mb-0"
                style="text-align: left"
              >
                3,000+
              </h4>
    ...
    <!-- End: All Products -->
    <section
      id="floralingoDictionary"
      class="my-5 mt-5"
      style="background: #fff6f9"
    >
      <section
