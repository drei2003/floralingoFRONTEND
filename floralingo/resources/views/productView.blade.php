...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/styles.min.css?h=5ac983ffa04040930ac80f5b0f2cad54" />
</head>
  ...
  <section class="mt-5">
    <div class="container">
      <div class="row d-md-flex justify-content-md-center">
        <div class="col-md-8 col-lg-5 col-xl-5 col-xxl-5" style="position: relative">
          <aside style="position: sticky" class="mb-5">
            <div class="card d-flex"
              ...
              <div class="d-flex justify-content-center align-items-center" style="padding: 3px;">
                <img class="rounded img-fluid" id="productIMG-5" src="{{ $product->Thumbnail_url }}"
              ...
              {{-- ❌ Remove the outer <form> --}}
                ...
                <div style="margin-top: 15px">
                  ...
                  <div class="mt-xl-3 px-0" style="padding-left: 16px; padding-right: 16px; margin-top: 12px;">
                    <h6 class="fw-bold mb-xl-2 mb-2" style="padding-bottom: 0px">Description</h6>
                    <p style="margin-top: 10px; margin-bottom: 10px">{{ $product->Description }}</p>
                  </div>
        ...
        <div class="col-10 col-sm-6 col-md-4 col-lg-3 col-xl-3 px-3" style="margin-top: 35px; margin-bottom: 2px;">
          ...
          <div class="card-img-overlay d-flex justify-content-end align-items-end pt-4 px-xl-3 py-xl-3">
            ...
            <button class="btn btn-secondary" type="submit"
              ...
              stroke-linejoin="round" class="icon icon-tabler icon-tabler-shopping-cart-plus"
